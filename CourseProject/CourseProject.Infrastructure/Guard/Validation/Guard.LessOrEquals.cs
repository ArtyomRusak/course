...
namespace CourseProject.Infrastructure.Guard.Validation
{
    ...
    public static partial class Guard
    {
        ...
        public static void AgainstIsLessOrEqualsThan<TValue>(TValue valueForCompare, TValue value)
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsLessOrEqualsThan<TValue>(valueForCompare, value, comparer);
        }
        ...
        public static void AgainstIsLessOrEqualsThan<TValue>(TValue valueForCompare, TValue value, Exception exception)
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsLessOrEqualsThan<TValue>(valueForCompare, value, comparer, exception);
        }
        ...
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsLessOrEqualsThan<TValue>(valueForCompare, value, comparer, parameterName);
        }
        ...
        /// <param name="valueForCompare">Value of object to compare</param>
        /// <param name="value">Value of object to compare</param>
        public static void AgainstIsLessOrEqualsThan<TValue, TException>(TValue valueForCompare, TValue value)
            where TException : Exception, new()
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsLessOrEqualsThan<TValue, TException>(valueForCompare, value, comparer);
        }
        ...
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsLessOrEqualsThan<TValue, TException>(valueForCompare, value, comparer, message);
        }
        ...
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsLessOrEqualsThan<TValue, TException>(valueForCompare, value,
