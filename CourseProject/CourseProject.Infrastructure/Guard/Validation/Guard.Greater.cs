...
namespace CourseProject.Infrastructure.Guard.Validation
{
    ...
    public static partial class Guard
    {
        ...
        public static void AgainstIsGreaterThan<TValue>(TValue valueForCompare, TValue value)
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsGreaterThan<TValue>(valueForCompare, value, comparer);
        }
        ...
        public static void AgainstIsGreaterThan<TValue>(TValue valueForCompare, TValue value, Exception exception)
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsGreaterThan(valueForCompare, value, comparer, exception);
        }
        ...
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsGreaterThan<TValue>(valueForCompare, value, comparer, parameterName);
        }
        ...
        /// <param name="valueForCompare">Value of object to compare</param>
        /// <param name="value">Value of object to compare</param>
        public static void AgainstIsGreaterThan<TValue, TException>(TValue valueForCompare, TValue value)
            where TException : Exception, new()
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsGreaterThan<TValue, TException>(valueForCompare, value, comparer);
        }
            ...
            where TException : Exception, new()
        {
            comparer = comparer ?? Comparer<TValue>.Default;
            int resultOfCompare = comparer.Compare(valueForCompare, value);
            if (resultOfCompare > 0) Guard.Throw<TException>();
        }
        ...
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsGreaterThan<TValue, TException>(valueForCompare, value, comparer, message);
        }
        ...
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsGreaterThan<TValue, TException>(valueForCompare, value, 
