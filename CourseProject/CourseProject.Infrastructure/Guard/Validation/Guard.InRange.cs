...
namespace CourseProject.Infrastructure.Guard.Validation
{
    ...
    public static partial class Guard
    {
        ...
        public static void AgainstIsInRange<TValue>(TValue value, TValue leftBorder, TValue rightBorder)
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsInRange<TValue>(value, leftBorder, rightBorder, comparer);
        }
        ...
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsInRange<TValue>(value, leftBorder, rightBorder, comparer, exception);
        }
        ...
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsInRange<TValue>(value, leftBorder, rightBorder, comparer, parameterName);
        }
        ...
        /// <param name="leftBorder">Left border of range</param>
        /// <param name="rightBorder">Right border of range</param>
        public static void AgainstIsInRange<TValue, TException>(TValue value, TValue leftBorder, TValue rightBorder)
            where TException : Exception, new()
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsInRange<TValue, TException>(value, leftBorder, rightBorder, comparer);
        }
        ...
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsInRange<TValue, TException>(value, leftBorder, rightBorder, comparer, message);
        }
        ...
        {
            var comparer = Comparer<TValue>.Default;
            Guard.AgainstIsInRange<TValue, TException>(value, leftBorder, rightBorder, comparer, parameterName, message);
        }
